...
import com.bookshop.entities.DanhMuc;
...
import com.bookshop.service.DanhMucService;
...
public class ClientController {
	...
	@GetMapping("/store")
	public String storePage(@RequestParam(defaultValue = "1") int page,@RequestParam(defaultValue = "") String range,@RequestParam(defaultValue = "") String brand,@RequestParam(defaultValue = "") String manufactor,Model model) {
