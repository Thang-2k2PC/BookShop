...
<body>
	...
	<div class="col-md-9 animated bounce">
      <h3 class="page-header">Quản lý Nhà sản xuất</h3>

      <button class="btn btn-success btnThemNhanHieu">Thêm mới Nhà sản xuất</button>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Tạo mới/Cập nhật Nhà sản xuất</h5>
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label for="name">Tên nhà sản xuất:</label> <input type="text"
