function sendContact()
{
	...
	$.ajax({
			...
			url: "http://localhost:8080/bookshop/createContact",
			success: function(result){
				alert("Cảm ơn quý khách đã liên hệ với chúng tôi. Book shop sẽ phản hồi sớm cho các bạn");
				window.location.href = "/bookshop/contact";
			},
			error : function(e){
				alert("Error: ",e);
				console.log("Error" , e );
